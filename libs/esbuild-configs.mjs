...
export default {
    ...
    srcESM: {
        // logLevel: 'info',
        entryPoints: [`src/*.js`, `src/*.mjs`], // Input ESM file that defines the web component
    ...
    srcIIFE: {
        // logLevel: 'info',
        entryPoints: [`src/*.js`, `src/*.mjs`], // Same input file
        minify: true, // Minify the output
    ...
    alphaESM: {
        // logLevel: 'debug',
        entryPoints: [`src/alpha/*.js`, `src/alpha/*.mjs`], // Input ESM file that defines the web component
        minify: true, // Minify the output
        bundle: true, // Bundle all dependencies into the output
        sourcemap: true, // Generate source map file
        format: 'esm', // ESM output format
    ...
    alphaIIFE: {
        // logLevel: 'info',
        entryPoints: [`src/alpha/*.js`, `src/alpha/*.mjs`], // Same input file
        minify: true, // Minify the output
        bundle: true, // Bundle all dependencies
        sourcemap: true, // Generate source map file
        format: 'iife', // IIFE output format
    ...
    preAlphaIIFE: {
        // logLevel: 'info',
        entryPoints: [`src/experiments/*.js`, `src/experiments/*.mjs`],
        minify: true, // Minify the output
        bundle: true, // Bundle all dependencies
        sourcemap: true, // Generate source map file
        format: 'iife', // IIFE output format
    ...
    preAlphaESM: {
        // logLevel: 'debug',
        entryPoints: [`src/experiments/*.js`, `src/experiments/*.mjs`], // Input ESM file that defines the web component
        minify: true, // Minify the output
        bundle: true, // Bundle all dependencies into the output
        sourcemap: true, // Generate source map file
        format: 'esm', // ESM output format
