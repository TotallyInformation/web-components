...
* [ ] Add checkbox option to allow for checkboxes to be added to list items. Where (un)tick actions emit a custom event and, if UIBUILDER for Node-RED is loaded, send an update message back to Node-RED.
