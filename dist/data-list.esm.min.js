...
`,l=class extends p{static componentVersion="2025-06-03";#t=null;#s=null;#e=null;#i="ul";listvar=null;keyvalueseparator=" :: ";static get observedAttributes(){return["inherit-style","name","keyvalueseparator","liststyle","listvar","type","topic"]}constructor(){super(),this.prependStylesheet(f,0)}connectedCallback(){if(this._connect(),this.listvar&&window[this.listvar]){window[this.listvar]?this.data=window[this.listvar]:console.warn(`[DataList] ${this.id} window.${this.listvar} does not exist, ignoring.`);return}this._ready()}disconnectedCallback(){this._disconnect()}attributeChangedCallback(t,e,s){e!==s&&(this[t]=s,this._event("attribChanged",{attribute:t,newVal:s,oldVal:e}))}set type(t){["ul","ol"].includes(t)||(console.warn(`[DataList] ${this.id} Invalid type "${t}" specified, defaulting to "ul".`),t="ul"),this.#i=t,this._updateListAttributes(this.#t,this.#i)}get type(){return this.#i}set liststyle(t){this.#s=t,this._updateListAttributes(this.#t,this.#i)}get liststyle(){return this.#s}set data(t){this.#e=t,this.#t&&this.#t.remove(),this._buildList(this.#e,this,this.#i,1),this.#t=this.querySelector("ul"),this._updateListAttributes(this.#t,this.#i),this._event("dataChanged",this.#e)}get data(){return this.#e}entry(t,e){this.#e[t]=e,this.data=this.#e}_buildList(t,e,s,i){i===void 0&&(i=1);let r=document.createElement("ul");i>1&&(r.classList.add("nested-list"),r.setAttribute("data-depth",i.toString())),Object.entries(t).forEach(([n,a],u)=>{let b=!isNaN(parseInt(n));if(typeof a=="object"&&a!==null){if(i>3){r.insertAdjacentHTML("beforeend",this._buildLIhtml({arrayType:Array.isArray(t),key:n,value:JSON.stringify(a),i:u})),console.warn(`[DataList] ${this.id} buildList: Depth limit reached for key "${n}", showing as string.`);return}let o=document.createElement("li");if(!b&&this.keyvalueseparator!=="NULL"){let c=document.createElement("span");c.textContent=`${n}${this.keyvalueseparator}`,o.appendChild(c)}else o.classList.add("nested-container");this._buildList(a,o,s,++i),this._updateListAttributes(o,s),r.appendChild(o)}else r.insertAdjacentHTML("beforeend",this._buildLIhtml({arrayType:Array.isArray(t),key:n,value:a,i:u}))}),e.appendChild(r)}_buildLIhtml({arrayType:t,key:e,value:s,i}){return t?`<li id="${this.id}-${e}" data-index="${i}">${s}</li>`:`<li id="${this.id}-${e}" data-index="${i}">${this.keyvalueseparator==="NULL"?"":`${e}${this.keyvalueseparator}`}${s}</li>`}_updateListAttributes(t,e){t&&(t&&(t.setAttribute("data-list-type",e),e==="ol"?(this.listStyle="decimal",t.setAttribute("aria-label","Ordered list")):(this.listStyle="disc",t.setAttribute("aria-label","Unordered list"))),this.#s&&t.style.setProperty("--list-style",this.#s))}},$=l;window.DataList=l;customElements.define("data-list",l);export{$ as default};
