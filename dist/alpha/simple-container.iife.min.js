...
`;var n=class extends l{static componentVersion="2025-05-29";static get observedAttributes(){return["inherit-style","name"]}constructor(){super(),o&&o.content&&this._construct(o.content.cloneNode(!0))}connectedCallback(){this._connect(),this._ready()}disconnectedCallback(){this._disconnect()}attributeChangedCallback(t,e,i){e!==i&&(this[t]=i,this._event("attribChanged",{attribute:t,newVal:i,oldVal:e}))}},b=n;window.SimpleContainer=n;customElements.define("simple-container",n);})();
