...
`;var r=class extends h{static componentVersion="2025-05-29";static get observedAttributes(){return["inherit-style","name"]}constructor(){super(),a&&a.content&&this._construct(a.content.cloneNode(!0))}connectedCallback(){this._connect(),this._ready()}disconnectedCallback(){this._disconnect()}attributeChangedCallback(t,e,i){e!==i&&(this[t]=i,this._event("attribChanged",{attribute:t,newVal:i,oldVal:e}))}},b=r;window.SimpleContainer=r;customElements.define("simple-container",r);})();
